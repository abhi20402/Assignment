...
import WithdrawFunds from '@/components/portfolio/WithdrawFunds'
...
export default function WithdrawFundsPage() {
  ...
  return <Box sx={{ minHeight: '100vh', backgroundColor: theme.palette.background.default }}><Header /><Box sx={{ pt: '64px' }}><AccountLayout><WithdrawFunds /></AccountLayout></Box></Box>
}
